...
<h4>商品管理 / 发布商品</h4>
<div id="container">
    <form class="layui-form" action="GoodsAddServlet" method="post" enctype="multipart/form-data" onsubmit="return checkInformation()">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="goodsName" name="goodsName" placeholder="请输入商品名称"  class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="goodsPrice" name="goodsPrice" placeholder="请输入商品价格"  class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" id="goodsNum" name="goodsNum" placeholder="请输入商品数量"  class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text" >
            ...
            <div class="layui-input-block">
                <textarea name="goodsDetail" placeholder="图文详情" class="layui-textarea"></textarea>
            </div>
        </div>
